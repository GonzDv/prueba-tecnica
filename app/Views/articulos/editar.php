...
<form class="max-w-sm mx-auto bg-gray" action="<?= base_url('articulos/' . $articulo['id']); ?>" method="post">
    ...
    <div class="mb-5 form-group">
        ...
        <input value="<?= $articulo['descripcion'] ?>" 
    ...
    <div class="mb-5 form-group">
        ...
        <textarea value="<?= $articulo['contenido_articulo'] ?>" 
        name="contenido_articulo" id="contenido" rows="10"  class="block p-2.5 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Contenido del articulo"></textarea>
    </div>
    <div class="mb-5 form-group">
